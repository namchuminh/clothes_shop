            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(item => {
                        ...
                        if(item.color != null){
                            color_price = Number(item.color.price)
                            sum = sum + color_price;
                        }
                        ...
                        $('tbody').append(`
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>Kích Thước: ${item.detail_product.size.name}</li>
                                        <li>Màu Sắc: ${item.color != null ? item.color.name : ""} (+ ${color_price.toLocaleString('vi-VN')}đ)</li>
                                        <li>Phụ Kiện: ${item.topping != null ? item.topping.name : ""} (+ ${topping_price.toLocaleString('vi-VN')}đ)</li>
                                    </ul>
                                </td>
