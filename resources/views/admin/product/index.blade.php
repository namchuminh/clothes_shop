                        ...
                        $('tbody').append(`
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default" href="{{ route('admin.product.color') }}/?id=${item.id}">Màu Sắc</a>
                                    <a class="btn btn-default" href="{{ route('admin.product.topping') }}/?id=${item.id}">Phụ Kiện</a>
                                </td>
                                <td>
