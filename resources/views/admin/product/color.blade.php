            ...
            <div class="card-body">
                <form id="update-form" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="image">Chọn Màu Sắc</label>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Danh sách giá bán theo màu sắc</h5>
                    </div>
                    <!-- /.card-header -->
...
<script>
    $(document).ready(function() {
        ...
        function fetchDataColorProduct() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(item => {
                        let price = Number(item.color.price);
                        $('tbody').append(`
                            <tr>
                                <td>${rowNumber++}</td>
            ...
            function create() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success('Thêm Màu Sắc thành công!', 'Thành Công');
                    },
                    error: function(xhr) {
                        if (xhr.status === 401) {
                            refreshToken().done(function() {
                            ...
                            toastr.error('Thêm Màu Sắc thất bại!', 'Thất Bại');
                        }
                    }
                });
            }
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Xóa Màu Sắc thất bại!', 'Thất Bại');
                    }
                }
            });
        }
