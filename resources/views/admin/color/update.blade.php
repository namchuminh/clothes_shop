        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.color.index') }}">Quản Lý Màu Sắc</a></li>
                    <li class="breadcrumb-item active">Cập Nhật Màu Sắc</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <form id="update-form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Màu Sắc"
                                    name="name">
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <a class="btn btn-success" href="{{ route('admin.color.index') }}">Quay Lại</a>
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        window.location.href = '{{ route('admin.color.index') }}';
                    }
                }
            });
        }
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        if (xhr.status === 401) {
                            ...
                            toastr.error('Cập nhật Màu Sắc thất bại!', 'Thất Bại');
                        }
                    }
                });
            }
