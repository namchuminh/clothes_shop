            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex">
                        <input id="search-input" class="form-control col-md-2" type="text" placeholder="Tên màu sắc ">
...
<script>
    $(document).ready(function() {
        ...
        function fetchData(page, search = '') {
            $.ajax({
                url: `{{ $api_url }}colors?page=${page}&search=${search}`,
                method: 'GET',
                headers: {
                    ...
                    response.data.forEach(item => {
                        ...
                        $('tbody').append(`
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.color.update') }}/?id=${item.id}" class="btn btn-primary">Sửa</a>
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Lấy danh sách Màu Sắc thất bại!', 'Thất Bại');
                    }
                }
            });
        }
