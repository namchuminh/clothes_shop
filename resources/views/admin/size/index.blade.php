            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex">
                        <input id="search-input" class="form-control col-md-2" type="text" placeholder="Tên kích thước">
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Lấy danh sách Kích Thước thất bại!', 'Thất Bại');
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Xóa Kích Thước thất bại!', 'Thất Bại');
                    }
                }
            });
        }
