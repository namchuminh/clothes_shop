...
@section('title', 'Cập nhật Kích Thước')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.size.index') }}">Quản Lý Kích Thước</a></li>
                    <li class="breadcrumb-item active">Cập Nhật Kích Thước</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Kích thước"
                                    name="name">
                            </div>
                        </div>
                    </div>
            ...
            function update() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success('Cập nhật Kích Thước thành công!', 'Thành Công');
                        fetchData();
                    },
                    error: function(xhr) {
                        if (xhr.status === 401) {
                            ...
                            toastr.error('Cập nhật Kích Thước thất bại!', 'Thất Bại');
                        }
                    }
                });
            }
