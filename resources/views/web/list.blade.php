                        ...
                        <div class="range__barcustom">
                            ...
                            <div class="range-items">
                                <div class="price-input d-flex">
                                    ...
                                    <a href="#" class="theme-btn bg-dark border-radius-none">LỌC</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-9 col-lg-8 order-1 order-md-2">
                <div class="woocommerce-notices-wrapper" style="padding: 15px 20px;">
                    <div class="product-showing">
                        <h5><a href="#" class="title-sub"><span><img src="https://modinatheme.com/html/foodking-html/assets/img/filter.png" alt="img"></span> DANH SÁCH SẢN PHẨM</a></h5>
                    </div>
                    <div class="form-clt">
                        <div class="icon">
                ...
                success: function(response) {
                    ...
                    response.data.forEach(item => {
                        if(slugCategory != ""){
                            ...
                            $(".title-sub").html(`<span><img src="https://modinatheme.com/html/foodking-html/assets/img/filter.png" alt="img"></span> Loại Sản Phẩm: ${item.category.name}`);
                        }else{
                            $(".title-breadcrumb-top").html("DANH SÁCH SẢN PHẨM");
                            $(".title-sub").html(`<span><img src="https://modinatheme.com/html/foodking-html/assets/img/filter.png" alt="img"></span> DANH SÁCH SẢN PHẨM`);
                        }
