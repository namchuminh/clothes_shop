                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-7">
                            <div class="checkout-radio">
                                <p class="primary-text">Danh sách sản phẩm</p>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(item => {
                        let price = Number(item.detail_products.price) * Number(item.quantity) + Number(item.color == null ? 0 : item.color.price) * Number(item.quantity) + Number(item.topping == null ? 0 : item.topping.price) * Number(item.quantity)
                        sum += price;
                        sumProduct++;
                            ...
                            <tr class="cart-item">
                                ...
                                <td class="cart-item-price">
                                    <ul class="property">
                                        ...
                                        <li class="border-p">Màu Sắc: ${item.color == null ? "Không" : item.color.name} (${Number(item.color == null ? 0 : item.color.price).toLocaleString('vi-VN')}đ x ${item.quantity})</li>
                                        <li class="topping-p">Phụ Kiện: ${item.topping == null ? "Không" : item.topping.name} (${Number(item.topping == null ? 0 : item.topping.price).toLocaleString('vi-VN')}đ x ${item.quantity})</li>
                                    </ul>
                                </td>
                                <td>
