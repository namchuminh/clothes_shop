                ...
                <div class="col-xl-6">
                    <div class="cart-pragh-box">
                        <div class="cart-graph">
                            ...
                            <div class="chck">
                                <a href="{{ route('web.customer.index') }}" class="back-btn theme-btn bg-white border-radius-none">
                                Quay Lại
                                </a>
                                <a href="#" class="order-status theme-btn border-radius-none d-none bg-dark">
                                Hủy Đơn
                                </a>
                            </div>
                            ...
                            <tr class="cart-item">
                                ...
                                <td class="cart-item-price">
                                    <ul class="property">
                                        ...
                                        <li class="border-p">Màu Sắc: ${item.color == null ? "Không" : item.color.name} (${Number(item.color == null ? 0 : item.color.price).toLocaleString('vi-VN')}đ)</li>
                                        <li class="topping-p">Phụ Kiện: ${item.topping == null ? "Không" : item.topping.name} (${Number(item.topping == null ? 0 : item.topping.price).toLocaleString('vi-VN')}đ)</li>
                                    </ul>
                                </td>
                                <td>
