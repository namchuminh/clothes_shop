...
<html lang="en">
    ...
    <head>
        ...
        <!-- ======== Page title ============ -->
        <title>H2T - Mua sắm quần áo trực tuyến, chất lượng, giá rẻ!</title>
        <!--<< Favcion >>-->
    ...
    <body>
                    ...
                    <div class="offcanvas__content">
                        ...
                        <div class="offcanvas__contact">
                            ...
                            <div class="header-button mt-4">
                                <a href="{{ route('web.product.list') }}" class="theme-btn bg-dark">
                                <span class="button-content-wrapper d-flex align-items-center justify-content-center">
                                <span class="button-icon"><i class="flaticon-delivery"></i></span>
                                <span class="button-text">Mua Sắm Ngay</span>
                                </span>
                                </a>
                            </div>
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-top-wrapper">
                        <ul>
                            <li><span>Miễn phí</span> vận chuyển đơn trên 500k</li>
                            <li><i class="fas fa-truck"></i>Theo dõi đơn hàng</li>
                        </ul>
                        <div class="top-right">
                    ...
                    <div class="mega-menu-wrapper">
                        <div class="header-main">
                                    ...
                                    <div class="main-menu">
                                        <nav id="mobile-menu">
                                            <ul class="link-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('web.product.list') }}">SẢN PHẨM</a>
                                                </li>
                                            </ul>
                                        </nav>
                                        <!-- for wp -->
                            ...
                            <div class="header-right d-flex justify-content-end align-items-center">
                                ...
                                <div class="menu-cart">
                                    <a href="{{ route('web.auth') }}" class="cartList">
        ...
        <!-- Hero Section Start -->
        <section class="hero-section-5 fix hero-6 section-padding bg-cover" style="background-image: url('images/slideshow_3.png'); padding: 350px;"></section>

        <!-- Food Menu Section Start -->
        <section class="food-menu-section pt-80 pb-80">
            <div class="container">
                <div class="section-title text-center mb-0">
                    <h4 class="menu-title wow fadeInUp bg-dark" data-wow-delay=".3s">LỰA CHỌN THỜI TRANG</h4>
                </div>
        ...
        <section class="popular-dishes-section fix section-padding pt-0">
            <div class="container">
                <div class="section-title text-center">
                    <h4 class="menu-title wow fadeInUp bg-dark" data-wow-delay=".3s" style="padding-top: 16px;"> DANH SÁCH SẢN PHẨM MỚI</h4>
                </div>
        ...
        <footer class="footer-section section-bg-3 fix bg-cover">
            <div class="container">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 pe-md-2 wow fadeInUp" data-wow-delay=".3s">
                            <div class="single-footer-widget pe-md-5 border-right">
                                ...
                                <div class="footer-content">
                                    <p>
                                        Nhập email của bạn vào bên dưới để
                                        theo dõi thông tin mới nhất cửa hàng.
                                    </p>
                ...
                <div class="container">
                    <div class="footer-bottom-wrapper d-flex align-items-center justify-content-between">
                        <p class="wow fadeInLeft" data-wow-delay=".3s">
                            © Bản quyền thuộc <span class="theme-color-3">2024</span> <a href="{{ route('web.home') }}">H2T Shop </a>. Tất cả nội dung.
                        </p>
                        <ul class="wow fadeInRight" data-wow-delay=".5s">
                            <li>
                                <a href="contact.html">
                                <span class="text-effect">
                                <span class="effect-1">Chính Sách</span>
                                <span class="effect-1">Chính Sách</span>
                                </span>
                                </a>
                            </li>
                            <li>
                                <a href="contact.html">
                                <span class="text-effect">
                                <span class="effect-1">Điều Khoản</span>
                                <span class="effect-1">Điều Khoản</span>
                                </span>
                                </a>
                            </li>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.data.forEach(item => {
                    const url = `/loai-san-pham/${encodeURIComponent(item.slug)}`;
                    $('.link-menu').append(`
                        <li>
                    ...
                    if(rowNumber == 1){
                        $('.food-menu-card-wrapper').append(`
                            <div class="food-menu-card-items wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="menu-thumb" style="height: 200px;">
                                    <a href="${url}">
                                        <img style="width: 200px; height: 200px;" src="{{ asset('storage') }}/${item.image}" alt="${item.name}" alt="img">
                                    </a>
                                </div>
                                <h5 class="title">
                                    <a href="${url}">${item.name}</a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.data.forEach(item => {
                        ...
                        const url = `/san-pham/${encodeURIComponent(item.slug)}-${item.id}.html`;
