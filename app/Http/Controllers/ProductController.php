...
class ProductController extends Controller
{
    ...
    public function color($id){
        ...
        $productBorders = ProductColor::with('color')->where('product_id',$id)->get();
    ...
    public function storeColor(Request $request, $id){
        ...
        // Tạo chi tiết sản phẩm mới
        $productBorder = new ProductColor();
        $productBorder->product_id = $id;
        $productBorder->color_id = $validatedData['color_id'];
        $productBorder->save();
    ...
    {
        // Tìm chi tiết sản phẩm theo ID
        $productBorder = ProductColor::find($id);
