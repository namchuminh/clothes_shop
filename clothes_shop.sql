...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2024 at 06:16 PM
...
(2, 'Hải Sản', 'images/7hReLat9SigoEDhnUB3QrNzAQE03fmg8SajO5QDp.jpg', 'hai-san', NULL, '2024-09-30 01:47:39'),
...
(9, 'Xanh Dương', 150000, '2024-09-30 02:29:10', '2024-09-30 02:29:10'),
(10, 'Đen', 0, '2024-09-30 07:16:51', '2024-09-30 07:16:51');
...
(2, 3, 'Nguyễn Văn Khách', '0999888999', 'Hà Nội', '2024-07-31 17:48:15', '2024-08-04 06:23:35'),
...
INSERT INTO `detail_orders` (`id`, `detail_product_id`, `order_id`, `color_id`, `topping_id`, `quantity`, `created_at`, `updated_at`) VALUES
...
(11, 4, 8, 8, 3, 2, '2024-08-04 12:40:43', '2024-08-04 12:40:43'),
(14, 4, 11, 9, 2, 1, '2024-09-30 09:03:01', '2024-09-30 09:03:01');
...
(9, 15, 8, 150000, '2024-09-30 02:40:16', '2024-09-30 02:40:16');
...
(6, '1EF0335B7AE113', 2, 2, 'Tầng 1, Tòa ABC, Đường XYZ, Quận JQK', '0999888999', 1, 115000, 3, NULL, '2024-08-02 17:19:32', '2024-08-07 09:56:19'),
(7, '1081C297B3C420', 2, 1, 'Tầng 1, Tòa ABC, Đường XYZ, Quận JQK', '0999888999', 1, 100000, 2, NULL, '2024-08-02 17:25:30', '2024-08-06 11:44:18'),
(8, 'ED82391CF0341B', 4, 1, 'Tầng 1, Tòa ABC, Đường XYZ, Quận JQK', '0999888999', 1, 54000, 2, NULL, '2024-08-04 12:40:43', '2024-08-06 11:44:04'),
(11, '7E60A983EB53AA', 2, 1, 'Hà Nội', '0999888999', 1, 178000, 3, NULL, '2024-09-30 09:03:01', '2024-09-30 09:16:20');
...
(9, 'Pizza 2', 'Mô tả ngắn', 'Mô tả dài', 'images/vQPtg4Oou2bi2wCZXU2uXjPzr2iJZYy1fdrt7EMm.jpg', 'pizza-21', 15, '2024-07-23 08:00:34', '2024-09-30 02:20:07', 2),
...
(15, 'Áo Sơ Mi Simwood Denim 1479', '- Thiết kế hai túi ngực với viền túi bản to trẻ trung, khỏe khoắn\r\n- Phối khuy màu nổi bật, tinh tế trên nền vải chính\r\n- Có thể diện đơn hoặc mặc khoác ngoài.', '<p><strong>SƠ MI KAKI SIMWOOD DENIM 1479</strong></p><p><strong>KIỂU DÁNG:</strong> Regular fit<br>Sơ mi phom regular fit ôm vừa phải, tôn dáng, mặc rất thoải mái và dễ chịu.</p><p><strong>CHẤT LIỆU:</strong> 100% cotton<br>Chất vải có độ dày vừa phải, mềm mát, thoáng khí. Cấu trúc bề mặt vải chắc chắn, bền bỉ, ít nhăn và không xù lông trong quá trình sử dụng.</p><p><strong>ĐẶC ĐIỂM NỔI BẬT</strong><br>- Thiết kế hai túi ngực với viền túi bản to trẻ trung, khỏe khoắn<br>- Phối khuy màu nổi bật, tinh tế trên nền vải chính<br>- Có thể diện đơn hoặc mặc khoác ngoài.</p><p><strong>HƯỚNG DẪN BẢO QUẢN</strong><br>- Lần giặt đầu tiên chỉ xả nước lạnh ( không dùng nước nóng hay nước giặt) rồi phơi khô để sợi vải và màu áo không bị xù&nbsp;<br>- Tốt nhất nên giặt tay, nhiệt độ thích hợp là từ 30 - 40 độ giúp áo được giặt sạch mà không lo hư tổn<br>- Nếu giặt máy, nên chọn chế độ giặt nhẹ, phù hợp với chất vải&nbsp;<br>- Không nên sử dụng chất giặt tẩy.&nbsp;<br>- Không nên ngâm chung với trang phục ra bị màu.&nbsp;<br>- Khi phơi lộn trái và không phơi trực tiếp dưới ánh nắng mặt trời</p>', 'images/JcmosghVD1ZgWGTVeOxcV0ElV70RWYc8rcp5bWad.png', 'ao-so-mi-simwood-denim-1479', 244, '2024-09-30 02:39:59', '2024-09-30 02:39:59', 3);
...
(9, 9, 9, '2024-09-30 07:32:09', '2024-09-30 07:32:09'),
(11, 9, 10, '2024-09-30 07:36:08', '2024-09-30 07:36:08');
...
(3, 3, 'khachhang@gmail.com', NULL, '$2y$10$dil3Fg6MvQRcSpY7lXYpQulxO7Ig7ybxzkhlMJ04YbmLwyAUy328e', 1, NULL, '2024-07-31 17:38:06', '2024-08-05 10:50:27'),
...
ALTER TABLE `carts`
  ...
  ADD KEY `border_id` (`color_id`,`topping_id`);
...
ALTER TABLE `product_colors`
  ...
  ADD KEY `product_border_border_id_foreign` (`color_id`);
...
--
ALTER TABLE `product_colors`
  ADD CONSTRAINT `product_border_border_id_foreign` FOREIGN KEY (`color_id`) REFERENCES `colors` (`id`) ON DELETE CASCADE,
